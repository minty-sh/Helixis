...
@Command(name = "url", mixinStandardHelpOptions = true, description = "URL encoding and decoding utilities.", subcommands = {
        UrlCommand.EncodeCommand.class, UrlCommand.DecodeCommand.class})
public class UrlCommand {
    ...
    static class EncodeCommand implements Callable<Integer> {
        ...
        @Option(names = {"-c",
                "--charset"}, description = "The charset to use for encoding (e.g., UTF-8). Defaults to UTF-8.")
    ...
    static class DecodeCommand implements Callable<Integer> {
        ...
        @Option(names = {"-c",
                "--charset"}, description = "The charset to use for decoding (e.g., UTF-8). Defaults to UTF-8.")
        private String charset = StandardCharsets.UTF_8.name();
