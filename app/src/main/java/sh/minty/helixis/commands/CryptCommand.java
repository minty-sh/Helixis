...
@Command(name = "crypt", mixinStandardHelpOptions = true, description = "Encrypts or decrypts a file using a reverse alphabet cipher.")
public class CryptCommand implements Callable<Integer> {
